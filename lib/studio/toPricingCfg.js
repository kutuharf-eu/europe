...
import { clamp, elementSizeCm, textLines, elementLabel, elementLabelKey } from '@/lib/studio/model';
...
export function toPricingItems(design) {
  ...
  for (const el of elements) {
    ...
    items.push({
      ...
      // Fiyat kartı etiketi çevirebilsin diye (adı olan görsellerde çeviri yok).
      labelKey: el.type === 'image' && el.name ? null : elementLabelKey(el),
      cfg: {
        ...base,
        text: '',
        heightCm: heightForEngine(heightCm),
